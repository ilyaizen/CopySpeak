...
Stateful CLI harness for CopySpeak TTS, a Windows Tauri desktop text-to-speech app.

## Requirements

- Python 3.10+
- Real CopySpeak TTS app built or installed (`COPYSPEAK_EXE` may point to it)
...
cli-anything-copyspeak --project demo.json queue add -t "Hello from CopySpeak TTS" --label hello
...
E2E tests require real CopySpeak TTS/TTS dependencies and fail if unavailable.

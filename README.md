...
Modern AI TTS Orchestrator. A lightweight Windows desktop app using AI Text-to-Speech engines. Trigger speech by quickly copying the same text twice in a row. No more manual pasting or hotkey pressing!

...
pub fn list_engines() -> Vec<EngineCatalogEntry> {
    vec![
        EngineCatalogEntry {
            ...
            description: "Run any local command-line TTS wrapper. Bring your own script or binary."
                .into(),
        ...
        EngineCatalogEntry {
            ...
            voices: vec![
                ...
                voice(
                    ...
                    "Ballad",
                    Some("en"),
                    Some("Singing-leaning, expressive"),
                    Some("male"),
                ),
                voice(
                    "coral",
        ...
        EngineCatalogEntry {
            ...
            voices: vec![
                ...
                voice(
                    ...
                    "Adam",
                    None,
                    Some("American · male · Dominant, Firm"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Alice",
                    None,
                    Some("British · female · Clear, Engaging Educator"),
                    Some("female"),
                ),
                voice(
                    ...
                    "Bella",
                    None,
                    Some("American · female · Professional, Bright, Warm"),
                    Some("female"),
                ),
                voice(
                    ...
                    "Bill",
                    None,
                    Some("American · male · Wise, Mature, Balanced"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Brian",
                    None,
                    Some("American · male · Deep, Resonant and Comforting"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Callum",
                    None,
                    Some("American · male · Husky Trickster"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Charlie",
                    None,
                    Some("Australian · male · Deep, Confident, Energetic"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Chris",
                    None,
                    Some("American · male · Charming, Down-to-Earth"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Daniel",
                    None,
                    Some("British · male · Steady Broadcaster"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Eric",
                    None,
                    Some("American · male · Smooth, Trustworthy"),
                    Some("male"),
                ),
                voice(
                    ...
                    "George",
                    None,
                    Some("British · male · Warm, Captivating Storyteller"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Harry",
                    None,
                    Some("American · male · Fierce Warrior"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Jessica",
                    None,
                    Some("American · female · Playful, Bright, Warm"),
                    Some("female"),
                ),
                voice(
                    ...
                    "Laura",
                    None,
                    Some("American · female · Enthusiast, Quirky Attitude"),
                    Some("female"),
                ),
                voice(
                    ...
                    "Liam",
                    None,
                    Some("American · male · Energetic, Social Media Creator"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Lily",
                    None,
                    Some("British · female · Velvety Actress"),
                    Some("female"),
                ),
                voice(
                    ...
                    "Matilda",
                    None,
                    Some("American · female · Knowledgable, Professional"),
                    Some("female"),
                ),
                voice(
                    ...
                    "River",
                    None,
                    Some("American · neutral · Relaxed, Neutral, Informative"),
                    Some("neutral"),
                ),
                voice(
                    ...
                    "Roger",
                    None,
                    Some("American · male · Laid-Back, Casual, Resonant"),
                    Some("male"),
                ),
                voice(
                    ...
                    "Sarah",
                    None,
                    Some("American · female · Mature, Reassuring, Confident"),
                    Some("female"),
                ),
                voice(
                    ...
                    "Will",
                    None,
                    Some("American · male · Relaxed Optimist"),
                    Some("male"),
                ),
            ],
        },
